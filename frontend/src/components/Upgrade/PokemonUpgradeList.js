...
export default function PokemonUpgradeList() {
    ...
    async function handleDelete(codigo, hora) {
        try {
            const userCpf = localStorage.getItem('cpf')
                ...
                userPokemons && imgPokemon ? (
                    <div className="w-100 m-0 p-0">
                        <AlertMessage show={show} setShow={setShow}
                            title="Erro"
                            msg="Sua data não foi alterada/deletada com sucesso :)"
                            button="Fechar"
                            func={() => setShow(false)}
                            colorAlert="danger"
                                    ...
                                    return (
                                        <Card key={pokemon.codigo_pokemon} className="w-auto w-lg-25 mr-5 mb-5">
                                            <Card.Body className="mb-3 mt-3">
                                                ...
                                                <Card.Title><span style={{ textTransform: 'capitalize' }}>{pokemon.raca} - ID {pokemon.codigo_pokemon}</span></Card.Title>
                                                <Card.Text>
                                                ...
                                                <ListGroup className="list-group-flush" variant="dark" text="light ">
                                                    <ListGroupItem className="mb-2 d-flex flex-column" variant="light" text="dark">
                                                        ...
                                                        {
                                                            (pokemon.input1) ? (
                                                                <EditDate handleClose={handleClose} pokemon={pokemon} inputNumber="input1" time="hora_de_entrada" setShow={setShow} />
                                                            ) : (
                                                                    <></>
                                                                )
                                                        }
                                                    ...
                                                    <ListGroupItem className="mb-2 d-flex flex-column" variant="light" text="dark">
                                                        ...
                                                        {
                                                            (pokemon.input2) ? (
                                                                <EditDate handleClose={handleClose} pokemon={pokemon} inputNumber="input2" time="hora_de_saida" setShow={setShow} />
                                                            ) : (
                                                                    <></>
                                                                )
                                                        }
                                                    ...
                                                    <ListGroupItem className="mb-2 d-flex flex-column" variant="light" text="dark">
                                                        <div className="mb-2 d-flex justify-content-between">
                                                            <p className="m-0 p-0">
                                                                Data de entrega: {pokemon.data_de_saida.slice(0, 19).split('T').join(' ')}
                                                            </p>
                                                            <img className="w-auto hover-cursor" alt="editar" src={editImg} onClick={(e) => handleOpen(e, pokemon.codigo_pokemon, 'input3')} />
                                                        </div>
                                                        {
                                                            (pokemon.input3) ? (
                                                                <EditDate handleClose={handleClose} pokemon={pokemon} inputNumber="input3" time="data_de_saida" setShow={setShow} />
                                                            ) : (
                                                                    <></>
                                                                )
                                                        }
                                                ...
                                                <div className="d-flex justify-content-center">
                                                    <Button className="mb-3 mt-3" variant="success" type="button" onClick={() => handleDelete(pokemon.codigo_pokemon, pokemon.hora_de_entrada)}>
                                                        Trabalho concluído
                                                    </Button>
                                                </div>
